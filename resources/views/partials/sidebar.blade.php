        ...
        <ul class="sidebar-menu">
            ...
            <li class=""><a href="{{ url('home') }}"><i class='fa fa-edit'></i> 
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('predios.predios.index')}}"><i class='glyphicon glyphicon-plus'></i>  Existentes </a></li>
                    <li><a href="{{route('predios.predios.create')}}"><i class='glyphicon glyphicon-plus'></i>  Nuevo </a></li>
                </ul>
            </li>
